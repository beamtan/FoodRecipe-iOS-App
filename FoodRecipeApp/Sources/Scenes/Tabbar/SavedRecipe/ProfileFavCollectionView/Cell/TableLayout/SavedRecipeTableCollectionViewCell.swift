//
//  SavedRecipeTableCollectionViewCell.swift
//  FoodRecipeApp
//
...
class SavedRecipeTableCollectionViewCell: UICollectionViewCell {
    static let identifier: String = "SavedRecipeTableCollectionViewCell"
